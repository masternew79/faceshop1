        ...
        <div class="row">
            <div class="col-md-2 sidebar">
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body">
                        <h4><span class="label label-danger">Giá</span></h4>
                        <div class="radio">
                          <label><input type="radio" name="price"> Duới 8 triệu</label>
                        </div>
                        <div class="radio">
                          <label><input type="radio" name="price"> Từ 8 - 10 triệu</label>
                        </div>
                        <div class="radio">
                          <label><input type="radio" name="price"> Từ 10 - 12 triệu</label>
                        </div>
                        <div class="radio">
                          <label><input type="radio" name="price"> Trên 12 triệu</label>
                        </div>
                        <h4><span class="label label-danger">Hãng</span></h4>
                        <div class="radio">
                          <label><input type="radio" name="trademark"> Asus</label>
                        </div>
                        <div class="radio">
                          <label><input type="radio" name="trademark"> Dell</label>
                        </div>
                        <div class="radio">
                          <label><input type="radio" name="trademark"> Acer</label>
                        </div>
                        <div class="radio">
                          <label><input type="radio" name="trademark"> Lenovo</label>
                        </div>
                        <div class="radio">
                          <label><input type="radio" name="trademark"> Apple</label>
                        </div>
            ...
            <div class="col-md-10 list">
                <ol class="breadcrumb">
                    ...
                    <div class="row text-right sort pull-right">
                        ...
                        <button type="button" class="btn btn-default btn-black btn-xs">Giá <i class="fa fa-caret-down"></i></button>
                        <button type="button" class="btn btn-default btn-black btn-xs">Lượt mua <i class="fa fa-caret-down"></i></button>
                        <button type="button" class="btn btn-default btn-black btn-xs">Lượt xem <i class="fa fa-caret-down"></i></button>
                    </div>
                </ol>
                <div class="col-md-3 col-xs-6 wow fadeInUp p5 " data-wow-delay="0.9s" >
                    <div class="col-md-12 thumbnail product">
                        <div class="view col-md-10 col-md-offset-1 text-center">
                            <i class="fa fa-eye"> 100</i>
                        </div>
                        <div class="label label-info tooltipleft" data-tooltip-content="#tooltip-content">
                            <i class="glyphicon glyphicon-align-left"></i>
                            <div class="tooltip-templates">
                                <div id="tooltip-content">
                                    <div class="panel panel-danger info">
                                        <div class="panel-heading text-center">Thông số kĩ thuật</div>
                                        <div class="panel-body">
